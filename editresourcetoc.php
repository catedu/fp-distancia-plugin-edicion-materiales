...
use local_educaaragon\output\editresourcetoc_page;
...
$PAGE->set_title(get_string('edittoc', 'local_educaaragon'));
$PAGE->set_heading(get_string('edittoc', 'local_educaaragon'));

$editresourcetoc = new editresourcetoc_page($resourceid);
